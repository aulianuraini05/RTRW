                    ...
                    <div class="rounded-2xl border border-gray-100 bg-white p-5 shadow-sm">
                        <div class="flex items-start justify-between">
                            <div>
                                ...
                                <p class="mt-2 text-3xl font-extrabold text-gray-900">{{ number_format($totalAnnouncements) }}</p>
                            </div>
                    ...
                    <div class="rounded-2xl border border-gray-100 bg-white p-5 shadow-sm">
                        <div class="flex items-start justify-between">
                            <div>
                                ...
                                <p class="mt-2 text-3xl font-extrabold text-gray-900">{{ number_format($activeAnnouncements) }}</p>
                            </div>
                    ...
                    <div class="rounded-2xl border border-red-100 bg-red-50/60 p-5 shadow-sm">
                        <div class="flex items-start justify-between">
                            <div>
                                ...
                                <p class="mt-2 text-3xl font-extrabold text-red-700">{{ number_format($urgentAnnouncements) }}</p>
                            </div>
                    ...
                    <div class="rounded-2xl border border-gray-100 bg-white p-5 shadow-sm">
                        <div class="flex items-start justify-between">
                            <div>
                                ...
                                <p class="mt-2 text-3xl font-extrabold text-gray-900">{{ number_format($totalRead) }}</p>
                            </div>
