                            ...
                            <tbody class="divide-y divide-gray-100 bg-white">
                                ...
                                @forelse ($announcements as $announcement)
                                    <tr class="transition hover:bg-gray-50/70">
                                        ...
                                        <td class="px-4 py-4">
                                            @if (Auth::user()->isAdmin())
                                                <a href="{{ route('announcements.readers', $announcement) }}" title="Lihat daftar pembaca" class="inline-flex items-center gap-1.5 text-gray-600 hover:text-emerald-600">
                                        ...
                                        <td class="px-4 py-4">
                                            <div class="flex items-center justify-end gap-1">
                                                @if (Auth::user()->isAdmin())
                                                    <a href="{{ route('announcements.readers', $announcement) }}" title="Daftar pembaca"
            ...
            @else
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        @foreach ($filters as $value => $label)
                            <a href="{{ route('announcements.index', array_merge(request()->except(['filter', 'page']), ['filter' => $value])) }}"
                                class="rounded-full px-4 py-2 text-sm font-semibold transition {{ request('filter', '') === $value ? 'bg-gray-900 text-white shadow-sm' : 'bg-white text-gray-600 ring-1 ring-gray-200 hover:bg-gray-50' }}">
                                {{ $label }}
                            </a>
                        @endforeach
                    </div>
                    ...
                    @empty
                        <div class="rounded-[20px] bg-white p-12 text-center border border-gray-100 shadow-sm">
