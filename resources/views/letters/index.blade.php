<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between gap-4">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ Auth::user()->isAdmin() ? 'Persuratan Warga' : 'Surat Saya' }}</h2>
                ...
                <article class="rounded-lg bg-white p-6 shadow-sm">
                    <div class="flex flex-col justify-between gap-4 sm:flex-row sm:items-start">
                        <div>
                            ...
                            <h3 class="text-lg font-semibold text-gray-900"><a href="{{ route('letters.show', $letter) }}" class="hover:text-indigo-600">{{ $letter->letter_type }}</a></h3>
