<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-lg text-gray-800 leading-tight">Tentukan Kas Bulan Ini</h2>
    </x-slot>

    <div>
        <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('kas_schedules.store') }}" class="space-y-6 rounded-lg bg-white p-6 shadow-sm">
                @csrf
                ...
                <div>
                    <x-input-label for="periode" value="Bulan Kas" />
                ...
                <div>
                    <x-input-label for="amount" value="Nominal Kas per Warga (Rp)" />
