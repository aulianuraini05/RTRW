<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between gap-4">
            <h2 class="font-semibold text-lg text-gray-800 leading-tight">Kas & Keuangan RT/RW</h2>
        ...
        <div class="space-y-6">
            ...
            <div class="grid gap-6 lg:grid-cols-3">
                ...
                <div class="rounded-lg bg-white p-6 shadow-sm border-l-4 border-gray-400">
                    ...
                    <p class="mt-2 text-lg font-bold text-gray-800">{{ $cashTransactions->total() }} catatan</p>
