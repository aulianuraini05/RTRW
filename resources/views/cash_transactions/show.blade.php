<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-lg text-gray-800 leading-tight">Detail Pembayaran Kas</h2>
    </x-slot>
                ...
                <div class="mt-4">
                    ...
                    @if ($cashTransaction->amount)
                        <div class="mt-3 rounded-md bg-gray-50 p-4">
                            ...
                            <p class="text-lg font-extrabold text-gray-900">Rp {{ number_format((float) $cashTransaction->amount, 0, ',', '.') }}</p>
                        </div>
                    @endif
